...
//        die();
    ...
    public function insertData($data, $employeeId){
        ...
        $sql = "INSERT INTO HRIS_KIOSK_PRINT_STAT(PRINT_ID,MONTH_ID,EMPLOYEE_ID,PRINT_TYPE {$loanKey} {$salaryTypeKey}) VALUES ((SELECT NVL(MAX(PRINT_ID),0)+1 FROM HRIS_KIOSK_PRINT_STAT),57,{$employeeId},'{$data['PrintType']}'{$loanInsert}{$salaryTypeInsert})";
